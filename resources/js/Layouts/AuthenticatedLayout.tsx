    ...
    if (!currentSection) {
        currentSection = filteredMenu.find((m: any) =>
            Array.isArray(m.children)
                ? m.children.some((c: any) => c.routeName ? route().current(c.routeName) : false)
                : false
        );
    }
    ...
    return (
        <Layout>
            <div className="min-h-screen bg-gray-100 flex flex-col">
                {/* Header */}
                <header
                    className="fixed z-50 w-full bg-white/90 backdrop-blur border-b border-app-header"
                >
                    <div className="w-full px-4 py-2.5 sm:px-6 lg:px-8 flex items-center justify-between">
                        <Link href="/" className="flex items-center gap-2">
                            <ApplicationLogo className="block h-6 w-auto fill-current text-app-primary" />
                        </Link>
                        ...
                        <div className="flex items-center">
                                        ...
                                        },
                                        {
                                            ...
                                            label: (
                                                <Link
                                                    ...
                                                    className="block px-3 py-2 text-app-primary hover:bg-app-secondary hover:text-app-primary transition-colors"
                                                >
                                        ...
                                        { type: "divider" as const },
                                        {
                                            ...
                                            label: (
                                                <Link
                                                    ...
                                                    method="post"
                                                    as="button"
                                                    className="block px-3 py-2 text-app-error hover:bg-app-error/10 hover:text-app-error transition-colors"
                                                >
                                                    <span className="inline-flex items-center gap-2">
                                                        <FontAwesomeIcon
                            ...
                            >
                                <button className="flex items-center gap-2 px-3 py-2 rounded-lg border border-app bg-app-card hover:bg-app-secondary hover:border-app-strong transition-colors">
                                    <Avatar
                                        size={28}
                                        className="bg-app-secondary text-app-primary"
                                    >
                ...
                {/* Contenu de la page */}
                <main className="p-4 sm:px-6 lg:px-8 flex-1 mt-20 bg-app-content">
                    {children}
                </main>
                ...
                <footer
                    ...
                    className="border-t border-app bg-app-card"
                >
